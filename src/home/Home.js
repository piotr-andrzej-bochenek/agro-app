      ...
      return (
        <div>
            ...
            <div className='Home__img--container'>
              <Image as={Link} to={'/pokoje'} className='Home__img' src={img1} />
              <Image as={Link} to={'/domki'} className='Home__img' src={img2} />
              <Image as={Link} to={'/cennik'} className='Home__img' src={img3} />
            </div>
            ...
            <div className='Home__img--container'>
              <Image as={Link} to={'/gospodarstwo'} className='Home__img' src={img4} />
              <Image as={Link} to={'/okolica'} className='Home__img' src={img5} />
            </div>
