...
export default class Cabins extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <h3>Domki</h3>
        <p>Do dyspozycji naszych gości oddajemy: 12 drewnianych domków letniskowych. Nasze komfortowe, drewniane domki letniskowe o powierzchni 30 m² znajdują się na terenie dużej ogrodzonej posesji. Każdy domek posiada zadaszony taras,komplet drewnianych mebli ogrodowych oraz miejsce parkingowe wewnątrz posesji.</p>
